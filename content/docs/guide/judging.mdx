...
<Cards>
  <Card title="Offline Judging" href="/docs/guide/offline-judging" description="Step-by-step guide to conducting in-person judging sessions." />
  <Card title="Online Judging" href="/docs/guide/online-judging" description="Learn how to manage judging remotely using Devfolio's platform." />
  <Card title="Sponsor Judging" href="/docs/guide/sponsor-judging" description="Instructions for sponsor reps to select prize winners for their tracks." />
</Cards>
