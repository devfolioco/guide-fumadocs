...
<Callout title="Hint">
You can hit the button "Sign in with magic link" below to sign in. This magic link is good for 30 minutes. In case it expires, don't worry; you can always request a new one.
</Callout>
