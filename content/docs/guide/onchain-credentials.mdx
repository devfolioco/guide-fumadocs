...
<Callout title="Note">
We launched the feature along with [ETHBarcelona 2023](https://ethbarcelona.devfolio.co/). You can check out the SBT collection on OpenSea: [opensea.io/collection/ethbarcelona](http://opensea.io/collection/ethbarcelona)
</Callout>
...
<Video src="https://www.youtube.com/embed/5uOUxk7H5J8" title="Onchain Credentials on Devfolio" />

- Onchain Credentials also rely on [EAS](https://attest.sh/) for attestations, just like [Cheer](cryptocheer) and [Quadratic Voting](quadratic-voting) on Devfolio.
...
With our **‘Claim’** feature, organizers can award builders with exclusive Onchain Credentials for their hackathon — and builders can claim them directly from their [dashboard](/docs/guide/participating-in-hackathons/claims/claiming-your-onchain-credentials)!
</Callout>
