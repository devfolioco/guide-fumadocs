...
<Caption>Starting a Side Project</Caption>
...
<Caption>Share your project on Twitter, LinkedIn, or copy the link</Caption>
...
1. Go to the [My Projects tab](https://devfolio.co/my-projects).
2. Find the project you want to update.
3. Click on **Edit**.
4. Make the necessary changes to your project details. In the description field, explain what this update is about or what you’ve built so far (this will be shown on your project page).
5. Click on **Save**.

<img src="/assets/6.gif" alt="Adding updates to a project" />

<Caption>Announce changes or additions via updates</Caption>