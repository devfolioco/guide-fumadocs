...
<Caption>A default slug is generated for you, with an option to edit it as per your preference depending upon the availability.</Caption>
...
The `Contact Email` field is how participants reach your team. Emails sent to participants of your hackathon, including announcements from the [Emails tab](/docs/guide/organizer-dashboard/emails-tab), are sent from a Devfolio address with your contact email set as the reply-to address, so any replies from participants land straight in your inbox.

### Things to remember

- You can make announcements by sending out emails to the participants of your hackathon. When participants reply to these emails, the replies go to the email ID you provide in the `Contact Email` field.
