...
- Visible in the [project submission](../../hackers/participate/project-submission.md) view for hackers  
...
<img src="/assets/image-8.10.webp" alt="Prizes Tab on Microsite" />
...
- Once the organizer updates Sponsors from the [sponsor tab](sponsors.md), a separate track opens up for them (right side) in the prizes tab  

---

## Here's a reference image on Adding Track Prize

<img src="/assets/image-8.11.webp" alt="Organizer Dashboard" />
<p align="center"><i>Organizer Dashboard</i></p>

<img src="/assets/image-8.12.webp" alt="ETHIndia'22 Microsite <> Prizes Tab" />
