...
You can find the `Settings` option in the drop-down after clicking on your profile in the top-right corner. This gives you access to a wide array of options that you can use to manage your account's visibility and security.

<img src="/assets/image (42).png" alt="Devfolio settings UI" />

## General Section

In the General section, you can perform a wide array of actions. They are as follows:
...
<img src="/assets/image (43).png" alt="Devfolio email notification settings" />
