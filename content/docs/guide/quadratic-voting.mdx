...
<Video src="https://www.youtube.com/embed/8QvPrwELBno" title="Quadratic Voting on Devfolio" />
...
6. Once voting ends, results will be live on the **hackathon leaderboard**
   ...
   <Caption>Check out the ETHforAll leaderboard: [ethforall.devfolio.co/leaderboard](https://ethforall.devfolio.co/leaderboard)</Caption>
