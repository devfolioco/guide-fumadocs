...
<Callout title="Note">
Please reach out to us regarding the activation of your hackathon in case you have already set it up on the organizer dashboard ([org.devfolio.co](http://org.devfolio.co/)).
</Callout>
