...
<Caption>You can keep track of their reimbursement status using the toggles on the extreme right.</Caption>
...
<Caption>Participant clothing & dietary needs</Caption>
